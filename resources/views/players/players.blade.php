...
<!-- Labels -->
      ...
      <div class="flex flex-row">
        <div class="m-1 text-xl font-bold basis-2/4 flex justify-start">        <h3>Manage players</h3></div>
        <div class="m-1 text-xl font-bold basis-2/4 flex justify-start visible"><h3>Show Players</h3></div>
      </div>
...
<!-- Text input 1 -->
              ...
              <div class="flex flex-row justify-start"> 
                <div class="mt-0 mr-0 mb-2.5 ml-0 bg-white border-2 border-solid border-Navy placeholder-Gray">
                  <input type="text" name="player" placeholder="Player" class="w-full">
                </div>
                <div class="pt-0 pr-0 pb-0 pl-1 text-red-500 font-bold">
                  @error('player') {{ $message }} @enderror
                  @if ($player !== false) {{ $player }} @endif
                </div>
              </div>
